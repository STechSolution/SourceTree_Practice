...
if __name__ == '__main__':
    ...
    net
    netDog.py -t 192.168.1.108 -p 5555 -l -c # command shell
    netDog.py -t 192.168.1.108 -p 5555 -l -u=mytest.txt # upload to file
    netDog.py -t 192.168.1.108 -p 5555 -l -e=\"cat /etc/passwd\" # execute command
    echo 'ABC' | ./netcat.py -t 192.168.1.108 -p 135 # echo text to server port 135
    netDog.py -t 192.168.1.108 -p 5555 # connect to server
'''))
